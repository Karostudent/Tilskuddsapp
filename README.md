...
2. **Bygg og start containerne** med Docker Compose:
...
3. **Kjør i bakgrunnen** hvis ønskelig, ved å bruke denne kommandoen i stedet:
...
5. **Kontroller i Docker Desktop** at disse to containerne kjører:
...
Oppsettet bruker et fast lokalt utviklingspassord og trenger ingen konfigurasjon før oppstart. Appen har foreløpig ikke innlogging eller innsending av søknader. Bruk testdata.
